...
def proportion_of_gg_in_politics_multiple_lines(gg_df, pol_df, max_n=10):
    """ Plots proportion of users of gamergate in political dataframe, with multiple lines for varying min_posts per user, only check once user has posted min_posts in gamergate subreddits !
